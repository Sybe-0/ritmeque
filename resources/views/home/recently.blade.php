...
<body class="bg-custom-darkblue">
    ...
    <div class="flex h-screen w-screen text-xl ">
        ...
        <nav class="bg-custom-pink px-2 h-full max-w2/5 basis-1/5">
            ...
            <p class="p-2 cursor-pointer border-pink-600 border-b-[1px] hover:border-[1px] hover:border-pink-600 hover:text-gray-400 hover:bg-pink-800 rounded-[4px]"><a href="/home/recently">Recently Viewed</a>
            </p>
